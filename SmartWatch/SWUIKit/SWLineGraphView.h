...
@interface SWLineGraphView : UIView
...
@property (nonatomic) NSUInteger xIntervalCount;
@property (nonatomic, strong) NSString *xAxisDescription;
 ...
 */
@property (nonatomic) float yAxisRange;
@property (nonatomic) int yIntervalCount;
@property (nonatomic, strong) NSString *yAxisDescription;
...
UIKIT_EXTERN NSString *const kXAxisDescLabelColorKey;

UIKIT_EXTERN NSString *const kXAxisDescLabelFontKey;
 ...
 */
UIKIT_EXTERN NSString *const kYAxisDescLabelColorKey;

UIKIT_EXTERN NSString *const kYAxisDescLabelFontKey;
